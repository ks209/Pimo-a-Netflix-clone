...
const Nav =()=>{
  ...
  useEffect(() =>{
    ...
    return <nav style={{backgroundColor: show ? 'rgb(25, 11, 22)': 'transparent'}}>
        <section>
            <div className="nav_left">
                <img 
                className="nav_logo"
                alt="logo"
                src="https://i.postimg.cc/5N6gvZCh/logo-no-background.png"
                />
                <div></div>
      ...
      <img
            ...
            src='https://giffiles.alphacoders.com/764/76462.gif'
            alt='avatar'
          />
